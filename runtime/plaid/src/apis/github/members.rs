use plaid_stl::github::{
    CheckOrgMembershipParams, ConsumedLicensesResponse, GitHubUser, GithubApiWrapper,
    RemoveOutsideCollaboratorParams,
};
...
impl Github {
    ...
    pub async fn get_enterprise_license_status(
        ...
        // only extracting the total number of consumed licenses, which is returned in the top-level JSON object.
